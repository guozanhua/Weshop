...
public class NumberAddSubView extends LinearLayout implements View.OnClickListener{
    ...
    public NumberAddSubView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            ...
            if (add == null)
                add = getResources().getDrawable(R.drawable.bg_btn_add_sub, null);
            if (sub == null)
                sub = getResources().getDrawable(R.drawable.bg_btn_add_sub, null);
            if (text == null)
                text = getResources().getDrawable(R.drawable.bg_text_view_num, null);
    ...
    private void initView() {
        View view = mInflater.inflate(R.layout.weight_number_add_sub, this, true);//根目录加
