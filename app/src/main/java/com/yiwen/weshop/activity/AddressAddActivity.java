...
import com.yiwen.weshop.city.XmlParserHandler;
import com.yiwen.weshop.city.model.CityModel;
import com.yiwen.weshop.city.model.DistrictModel;
import com.yiwen.weshop.city.model.ProvinceModel;
    ...
    private void createAddress() {
        ...
        mHelper.doPost(Contants.API.ADDRESS_CREATE, params, new SpotsCallback<BaseRespMsg>(this) {
            ...
            public void onSuccess(Response response, BaseRespMsg baseRespMsg) {
                Log.d(TAG, "onSuccess: "+baseRespMsg.getMessage());
                if (baseRespMsg.getStatus() == BaseRespMsg.STATUS_SUCCESS) {
                    setResult(RESULT_OK);
                    finish();
                }else {
                    ToastUtils.show(AddressAddActivity.this,"服务器出错");
                }
            }
