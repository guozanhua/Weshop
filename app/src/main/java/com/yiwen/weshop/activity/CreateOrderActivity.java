...
import com.yiwen.weshop.adapter.WaresOrderAdapter;
import com.yiwen.weshop.adapter.layoutmanager.FullyLinearLayoutManager;
import com.yiwen.weshop.bean.Charge;
import com.yiwen.weshop.bean.ShoppingCart;
import com.yiwen.weshop.bean.WareItem;
...
import com.yiwen.weshop.msg.CreateOrderRespMsg;
    ...
    private void postNewOrder() {
        ...
        mHelper.doPost(Contants.API.CREATE_ORDER, params, new SpotsCallback<CreateOrderRespMsg>(this) {
            ...
            public void onSuccess(Response response, CreateOrderRespMsg createOrderRespMsg) {
                if (BaseRespMsg.STATUS_SUCCESS!=createOrderRespMsg.getStatus()){
                    Log.d(TAG, "onSuccess: "+createOrderRespMsg.getStatus()+createOrderRespMsg.getMessage());
                    ToastUtils.show(CreateOrderActivity.this,"服务器返回出错，请稍后再试");
                ...
                Pingpp.createPayment(CreateOrderActivity.this, JSONUtil.toJSON(charge));
//                try {
